...
def init():
    ...
    model_name = 'iris_mbm_model'
    #model_save_file = 'iris_mbm_model.save.pkl'

    prediction_dc = ModelDataCollector(model_name, designation="predictions", feature_names=["SepalLengthCm","SepalWidthCm", "PetalLengthCm","PetalWidthCm","Predicted_Species"])

    model_path = Model.get_model_path(model_name)
    #model = joblib.load(model_path+"/"+model_save_file)
